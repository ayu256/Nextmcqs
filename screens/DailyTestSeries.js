...
<ScrollView>
    ...
    <View style={styles.series_view}>
        <View style={{backgroundColor:'#e6d9ec',marginVertical:5,width:50,
            borderRadius:5,padding:5,shadowOpacity: 1,
            shadowColor:'#000', 
            elevation: 4,left:10}}>
            <TouchableOpacity>
                <Text style={{color:'#5b0dad',fontFamily:'Poppins-Bold',fontSize:14,textAlign:'center'}}>Now 07 jun</Text>
            </TouchableOpacity>
        </View>

        <View >
            <Text style={{color:'#000',fontSize:14,fontWeight:'bold'}}>INICET 2021 MOCK TEST</Text>
